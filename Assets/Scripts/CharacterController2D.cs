...
public class CharacterController2D : MonoBehaviour {
	...
	[Range(0.0f, 10.0f)] 
	public float moveSpeed = 3f;	// default value is 3
	...
	// LayerMask to determine what layers are considered ground for the player
	...
	// player can move?
	// public so other scripts can access it but not seen on the editor
	[HideInInspector]
	...
	// underscore is used to denote private variables in this code
	...
	void Awake () {
		...
		// get a reference to the components and store a reference for efficiency purposes
		...
		if (_audio==null) { 
			...
			// added AudioSource component dynamically
		...
		// determine the platform's specified layer and return the layer number
		// here "Platform" is the name of the layer
	...
	void Update()
	{
		// exit update if player cannot move or game is paused(when timescale is 0)
	...
	// so that the player will move along the platform
